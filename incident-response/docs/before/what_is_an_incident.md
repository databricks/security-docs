...
## What is an incident?
Any unplanned disruption or degradation of service that is actively affecting customers ability to use databricks.
...
1. Can customers perform all incident response functions provided by databricks, across all platforms?
