...
description: There are several main roles for our incident response teams at databricks. This page describes each of our roles in detail, why it's important to have them, and what their responsibilities are.
---
There are several main roles for our incident response teams at databricks. Certain roles only have one person per incident (e.g. IC), whereas other roles can have multiple people (e.g. Subject Matter Expert, SME). It's all about coming together as a team, working the problem, and getting a solution quickly.
...
During larger complex incidents, the role structure may be adjusted to account for the creation of sub-teams. Read about how we handle [complex incidents](/before/complex_incidents) for more information.
...
Take a look at our [Incident Commander training guide](/training/incident_commander).
...
### How can I become one?
Take a look at our [Deputy training guide](/training/deputy). Deputies also need to be [trained as an Incident Commander](/training/incident_commander).
...
### How can I become one?
Follow our [Scribe training guide](/training/scribe), and then notify the Incident Commanders that you would like to be considered for scribing for the next incident.
...
### What is it?
A Subject Matter Expert (SME), sometimes called a "Resolver", is a domain expert or designated owner of a component or service that is part of the databricks software stack.
...
### How can I become one?
Take a look at our [Subject Matter Expert training guide](/training/subject_matter_expert). You should also discuss with your team and service owner to determine what the requirements are for your particular service.
...
### How can I become one?
Follow our [Customer Liaison training guide](/training/customer_liaison), and discuss with the Support Team about becoming our next Customer Liaison.
...
### How can I become one?
Follow our [Internal Liaison training](/training/internal_liaison).
