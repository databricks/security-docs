...
---
![Post-Mortem](../assets/img/headers/databricks_post_mortem.jpg)
...
1. Discuss how the problem could've been caught.
    * Did it show up in [canary](https://www.databricks.com/blog/continuous-build-break-fix-fast#canary-releases)?
