...
---
Information on what to do during a major incident. See our [severity level descriptions](/before/severity_levels) for what constitutes a major incident.
...
!!! warning "Security Incident?"
    If this is a security incident, you should follow the [Security Incident Response](/during/security_incident_response) process.
...
1. Keep track of your [span of control](/training/glossary#span-of-control). If the response starts to become larger, or the incident increases in complexity, consider [splitting off sub-teams](/before/complex_incidents#spinning-off-sub-teams) in order to get a more effective response.
...
1. Once the call is over, you can start to follow the steps from [After an Incident](/after/after_an_incident).
...
1. Notify internal stakeholders as necessary, adding subscribers to the databricks incident. We have pre-defined teams called "SEV-1 Stakeholders" and "SEV-2 Stakeholders" which can be used.
